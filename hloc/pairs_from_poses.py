...
def get_pairs_from_poses_txt_file(poses_txt_file, output_file_path, num_matched, rotation_threshold=DEFAULT_ROT_THRESH):
    
    logging.info('Reading the poses file...')
    images = read_image_poses_txt(poses_txt_file)
